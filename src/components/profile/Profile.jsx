    ...
    <div className="profile__inner p-relative">
      <div className="profile__shape">
        <img
          ...
          src="img/login/laptop.png"
          alt=""
        />
        <img
          className="profile__shape-2"
          src="img/login/man.png"
          alt=""
        />
        <img
          className="profile__shape-3"
          src="img/login/shape-1.png"
          alt=""
        />
        <img
          className="profile__shape-4"
          src="img/login/shape-2.png"
          alt=""
        />
        <img
          className="profile__shape-5"
          src="img/login/shape-3.png"
          alt=""
        />
        <img
          className="profile__shape-6"
          src="img/login/shape-4.png"
          alt=""
        />
      </div>
      <div className="row">
                ...
                <div className="profile__notification">
                  <div className="profile__notification-top mb-30">
                    ...
                    <p>
                      ...
                      involves you including mentions, messages, replies to your
