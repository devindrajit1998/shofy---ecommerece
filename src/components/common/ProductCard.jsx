    ...
    <>
      <div className="tp-product-item p-relative transition-3 mb-25">
        <div className="tp-product-thumb p-relative fix m-img">
          <a href="!#">
            <img src={`${BASE_URL}${thumbnail && thumbnail.data.attributes.url}`} alt="product-electronic" />
          </a>
          {/* product badge */}
          <div className="tp-product-badge">
            <span className="product-hot">{props.state}</span>
          </div>
          {/* product action */}
          <div className="tp-product-action">
            <div className="tp-product-action-item d-flex flex-column">
              ...
              <button
                ...
                onClick={()=>TargetProduct(data.createdAt)}
              >
                <svg
                  width={20}
                  height={17}
        ...
        <div className="tp-product-content">
          ...
          <div className="tp-product-price-wrapper">
            <span className="tp-product-price old-price">${mainPrice}</span>
            <span className="tp-product-price new-price">${offerPrice}</span>
          </div>
        </div>
      </div>
    </>
